...
public class TestAdherentTroisEmprunts {
	...
	public static void main (String [] argv){
		...
		/**
		 * Scenario de test d'emprunt par les adherents 
		...
		try {
			ep1 = new EmpruntEnCours(uDao.findByKey(3), eDao.findByKey(1));
			ep2 = new EmpruntEnCours(uDao.findByKey(3), eDao.findByKey(2));
			ep3 = new EmpruntEnCours(uDao.findByKey(3), eDao.findByKey(3));
			uDao.findByKey(3).addEmpruntEnCours(ep1);
			uDao.findByKey(3).addEmpruntEnCours(ep2);
			uDao.findByKey(3).addEmpruntEnCours(ep3);
		...
		try {
			...
			ep4 = new EmpruntEnCours(uDao.findByKey(3), eDao.findByKey(4));
			uDao.findByKey(3).addEmpruntEnCours(ep4);
